...
const recentClaims = [
  { name: "Sarah P.", amount: 750 },
  { name: "Emily R.", amount: 500 },
  { name: "James M.", amount: 750 },
  { name: "Jessica M.", amount: 500 },
  { name: "Amanda T.", amount: 750 },
  { name: "Ashley C.", amount: 500 },
  { name: "David L.", amount: 750 },
  { name: "Melissa B.", amount: 500 },
  { name: "Stephanie W.", amount: 750 },
  { name: "Rebecca K.", amount: 500 },
  { name: "Laura S.", amount: 750 },
  { name: "Robert C.", amount: 500 },
...
export default function App() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#f3f4f6] flex flex-col items-center justify-center py-2 sm:py-10 px-4 font-sans selection:bg-green-100 selection:text-[#006241] overflow-hidden">
        ...
        {showNotification && (
          <div className="absolute top-0 bg-white rounded-full px-4 sm:px-6 py-2 sm:py-2.5 shadow-[0_2px_10px_rgb(0,0,0,0.04)] border border-gray-100 flex items-center gap-1.5 sm:gap-2 animate-in fade-in slide-in-from-top-4 duration-500 transition-all w-full sm:w-auto justify-center">
            ...
            <span className="text-gray-700 text-[13px] sm:text-[15px] whitespace-nowrap truncate">
              <span className="text-[#006241] font-medium">{recentClaims[claimIndex].name}</span> claimed ${recentClaims[claimIndex].amount}!
            </span>
          </div>
        )}
      </div>
      ...
      <div className="bg-white rounded-[24px] sm:rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.08)] w-full max-w-[380px] p-5 sm:p-8 pt-6 sm:pt-10 flex flex-col items-center animate-in fade-in zoom-in-95 duration-700 max-h-[calc(100svh-80px)] overflow-y-auto noscrollbar">
        ...
        <div className="flex items-center justify-center mb-4 sm:mb-8 shrink-0 pt-2 w-full">
          <img 
            ...
            alt="Starbucks" 
            className="w-[90px] sm:w-[110px] h-auto object-contain drop-shadow-sm"
            referrerPolicy="no-referrer"
          />
        </div>

        {/* Prize Value */}
        <h1 className="text-[#006241] text-[52px] sm:text-[72px] font-bold leading-none mb-1 sm:mb-3 tracking-tight shrink-0">
          $750
        </h1>
        ...
        <div className="bg-[#f2f3f5] rounded-[16px] sm:rounded-[24px] p-4 sm:p-6 w-full space-y-2.5 sm:space-y-4 mb-4 sm:mb-8 shrink-0">
          {[
            ...
            <div key={i} className="flex items-center gap-3 sm:gap-4">
              <div className="w-6 h-6 sm:w-7 sm:h-7 shrink-0 rounded-full bg-[#006241] text-white flex items-center justify-center text-[12px] sm:text-[13px] font-bold shadow-sm">
                {i + 1}
              </div>
        ...
        <button 
          onClick={() => window.location.href = 'https://giftclick.org/aff_c?offer_id=1741&aff_id=144760'}
          className="w-full bg-[#006241] hover:bg-[#004d33] transition-colors active:scale-[0.96] text-white rounded-full py-3 sm:py-4 px-4 text-[15px] sm:text-lg font-bold flex items-center justify-center gap-2 sm:gap-3 shadow-lg shadow-green-700/25 mb-3 sm:mb-6 group shrink-0"
        >
        ...
        <div className="flex flex-col items-center justify-center pt-1 shrink-0 scale-[0.85] sm:scale-100 transform origin-top">
          ...
          <div className="text-[13px] font-bold text-[#031d36] mb-1.5 uppercase tracking-[0.02em] text-center">
            4.8 OUT OF 5 BASED ON 8,294 REVIEWS
          </div>
